...
class UI {
   ...
   imprimirCitas() {
        ...
        //Leet el contenido de la base de datos
...
function creadDB(){
    ...
    //Si hay un error
    creadDB.error = function(){
        ui.imprimirAlerta('Error al crear la base de datos', 'error');
    }

    //Si todo sale bien
    creadDB.onsuccess = function(){
        ui.imprimirAlerta('Base de datos creada y lista', 'success');
